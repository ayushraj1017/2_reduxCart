...
import { decrement, increment,removeSingleItem } from "../redux/cart";


const CartItem = ({ id,img, title, price, amount,increment ,decrement,removeSingleItem}) => {
  ...
  return (
    <div className="cart-item">
      ...
      <div>
        ...
        {/* remove button */}
        <button onClick={()=>removeSingleItem(id)}
